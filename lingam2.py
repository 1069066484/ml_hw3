...
class LiNGAM():
    ...
    def _W_sklearn(self,X):
        A = FastICA(n_components=self.n_dim, random_state=self.random_state).fit(X).mixing_
...
if __name__ == '__main__':
    ...
    data = read_dataset_2(Datasets2.admissions)
    lingam = LiNGAM()
    lingam.fit(data,use_sklearn=True,random_state=1)
